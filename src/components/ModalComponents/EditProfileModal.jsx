    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-xl shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Field label="Mother" name="mother" value={form.mother} onChange={handleChange} />
          <Field label="Father" name="father" value={form.father} onChange={handleChange} />
        ...
        <div className="flex justify-end mt-6 gap-3">
          ...
          <button className="btn bg-purple-600 text-white" onClick={handleSave}>Save</button>
        </div>
